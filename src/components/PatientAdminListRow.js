...
function PatientAdminListRow(props) {
    const { _id, name, email, age, gender, problem, doj, bloodGroup } = props.obj;  //object destruction
    const handleClick = () => {
        Axios.delete("https://hms-deployment-backend.onrender.com/patientadminRoute/delete-patientadmin/" + _id)
            .then((res) => {
                if (res.status === 200) {
...
export default PatientAdminListRow;
